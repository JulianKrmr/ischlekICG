...
window.addEventListener("load", () => {
  ...
  const cameraTranslation = new GroupNode(
    new Translation(new Vector(0, -1, 12, 0))
  );
  ...
  function createLight(
    ...
    const bulbScaling = new GroupNode(
      new Scaling(new Vector(0.5, 0.5, 0.5, 1))
    );
    const lightJump = new JumperNode(
      lightTranslation,
      movementVector,
      0.001,
      false
  ...
  const createWindow = (
    ...
    const minimizerScaling = new GroupNode(
      new Scaling(new Vector(0.5, 0.3, 0.3, 0)),
      id
    );
  ...
  const pyramidTranslation = new GroupNode(
    new Translation(new Vector(-1, -2, 1, 0))
  );
  ...
  const sphereTranslation = new GroupNode(
    new Translation(new Vector(0, -0.5, 1, 0))
  );
  ...
  const taskbarTranslation = new GroupNode(
    new Translation(new Vector(0, -4, 0, 0))
  );
